...
const tasks = ref([
  { label: "Tugas 1", value: "https://namirasyalwa-projectcv.vercel.app/?authuser=0&hl=id" },
  { label: "Tugas 2", value: "https://tgs2pbk.vercel.app/" },
  { label: "Tugas 3", value: "https://223510694-namira.vercel.app/?authuser=0&hl=id" },
  { label: "Tugas 4", value: "https://tgs4-syalwas-projects.vercel.app/?authuser=0&hl=id" },
  { label: "Tugas 5", value: "https://tgs5pbk-sylw.vercel.app/?authuser=0&hl=id" },
  { label: "Tugas 6", value: "https://tgs6-syalwas-projects.vercel.app/?authuser=0&hl=id" },
]);
...
.weather-widget {
  ...
  box-shadow: 0 3px 10px rgba(201, 5, 5, 0.15);
  border-radius: 15px;
  text-align: center;
